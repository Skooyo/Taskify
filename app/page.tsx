...
const Task = [{
    title: "short task",
    description: "this is a short task this is a short task this is a short taskthis is a short task this is a short task this is a short taskthis is a short task",
    priority: "Urgent",
    storyPoints: 1,
    status: "In Progress",
  ...
  {
      title: "long task",
      description: "this is a long task this is a long task this is a long taskthis is a long task this is a long task this is a long taskthis is a long task",
      priority: "High",
      storyPoints: 3,
      status: "To Do",
    ...
    <main>
      <div className="h-screen w-full flex gap-8 pt-5">
        ...
        <div className="h-full w-full mr-4 flex-col">
          ...
          {/* Task Cards */}
          <div className="w-full h-fit p-4 grid grid-cols-4 gap-10">
            <TaskCard />
            <TaskCard />
            <TaskCard />
            <TaskCard />
