      ...
      >
        <div className="p-5 h-full flex flex-col items-center justify-center gap-3 bg-white">
          <h1 className="font-semibold p-2 text-center">
            Are you sure you want to stop the sprint?
          </h1>
          <div className="w-full flex gap-8 justify-between px-8 items-center">
            ...
            <button
              type="button"
              className="font-semibold items-center justify-center py-2 px-6 bg-red-500 text-background rounded-lg flex gap-2 text-white opacity-80"
              onClick={handleStop}
            >
              <p>Stop</p>
            </button>
...
export default StopSprintModal;
